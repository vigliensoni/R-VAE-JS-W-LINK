...
function isReadyToGenerate(){
  // console.log('GV in vae.isreadytogenerate');
  // console.log('GV', 'model:', model, 'model.isTrained:', model.isTrained);
...
async function loadModel(filepath){
  if (!model) initModel();
  await model.loadModel(filepath);
  // console.log('GV loadModel');
}
...
class ConditionalVAE {
  ...
  async loadModel(path){
    ...
    this.isTrained = true;
    // console.log('GV loadModel\n', 'decoder:', this.decoder, 'isTrained:', this.isTrained);
  }
}
